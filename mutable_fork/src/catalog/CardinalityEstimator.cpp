...
#define INSTANTIATE(TYPE, _1, _2) \
    ...
    template std::unique_ptr<DataModel> TYPE::operator()(estimate_join_all_tag, PlanTableLargeAndSparse &&PT, \
                                                         const QueryGraph &G, Subproblem to_join, \
                                                         const cnf::CNF &condition) const; \
    template std::unique_ptr<DataModel> TYPE::operator()(estimate_join_all_tag, TopKPlanTable<PlanTableSmallOrDense, 2> &&PT, \
                                                         const QueryGraph &G, Subproblem to_join, \
                                                         const cnf::CNF &condition) const; \
    template std::unique_ptr<DataModel> TYPE::operator()(estimate_join_all_tag, TopKPlanTable<PlanTableLargeAndSparse, 2> &&PT, \
                                                         const QueryGraph &G, Subproblem to_join, \
                                                         const cnf::CNF &condition) const; \
    template std::unique_ptr<DataModel> TYPE::operator()(estimate_join_all_tag, TopKPlanTable<PlanTableSmallOrDense, 3> &&PT, \
                                                         const QueryGraph &G, Subproblem to_join, \
                                                         const cnf::CNF &condition) const; \
    template std::unique_ptr<DataModel> TYPE::operator()(estimate_join_all_tag, TopKPlanTable<PlanTableLargeAndSparse, 3> &&PT, \
                                                         const QueryGraph &G, Subproblem to_join, \
                                                         const cnf::CNF &condition) const; \
    template std::unique_ptr<DataModel> TYPE::operator()(estimate_join_all_tag, TopKPlanTable<PlanTableSmallOrDense, 5> &&PT, \
                                                         const QueryGraph &G, Subproblem to_join, \
                                                         const cnf::CNF &condition) const; \
    template std::unique_ptr<DataModel> TYPE::operator()(estimate_join_all_tag, TopKPlanTable<PlanTableLargeAndSparse, 5> &&PT, \
                                                         const QueryGraph &G, Subproblem to_join, \
                                                         const cnf::CNF &condition) const; \
    template std::unique_ptr<DataModel> TYPE::operator()(estimate_join_all_tag, TopKPlanTable<PlanTableSmallOrDense, 10> &&PT, \
                                                         const QueryGraph &G, Subproblem to_join, \
                                                         const cnf::CNF &condition) const; \
    template std::unique_ptr<DataModel> TYPE::operator()(estimate_join_all_tag, TopKPlanTable<PlanTableLargeAndSparse, 10> &&PT, \
                                                         const QueryGraph &G, Subproblem to_join, \
                                                         const cnf::CNF &condition) const; \
    template std::unique_ptr<DataModel> TYPE::operator()(estimate_join_all_tag, TopKPlanTable<PlanTableSmallOrDense, 34> &&PT, \
                                                         const QueryGraph &G, Subproblem to_join, \
                                                         const cnf::CNF &condition) const; \
    template std::unique_ptr<DataModel> TYPE::operator()(estimate_join_all_tag, TopKPlanTable<PlanTableLargeAndSparse, 34> &&PT, \
                                                         const QueryGraph &G, Subproblem to_join, \
                                                         const cnf::CNF &condition) const; \
    template std::unique_ptr<DataModel> TYPE::operator()(estimate_join_all_tag, TopKPlanTable<PlanTableSmallOrDense, 35> &&PT, \
                                                         const QueryGraph &G, Subproblem to_join, \
                                                         const cnf::CNF &condition) const; \
    template std::unique_ptr<DataModel> TYPE::operator()(estimate_join_all_tag, TopKPlanTable<PlanTableLargeAndSparse, 35> &&PT, \
                                                         const QueryGraph &G, Subproblem to_join, \
                                                         const cnf::CNF &condition) const; \
    template std::unique_ptr<DataModel> TYPE::operator()(estimate_join_all_tag, HolisticPlanTable<PlanTableSmallOrDense> &&PT, \
                                                         const QueryGraph &G, Subproblem to_join, \
                                                         const cnf::CNF &condition) const; \
    template std::unique_ptr<DataModel> TYPE::operator()(estimate_join_all_tag, HolisticPlanTable<PlanTableLargeAndSparse> &&PT, \
                                                         const QueryGraph &G, Subproblem to_join, \
                                                         const cnf::CNF &condition) const;
LIST_CE(INSTANTIATE)
#undef INSTANTIATE
