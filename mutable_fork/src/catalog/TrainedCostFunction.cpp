...
#define INSTANTIATE(PLAN_TABLE) \
    template double TrainedCostFunction::operator()(calculate_filter_cost_tag, const PLAN_TABLE &PT, const QueryGraph &G, \
                                                    const CardinalityEstimator &CE, Subproblem sub,                       \
                                                    const cnf::CNF &condition) const; \
    template double TrainedCostFunction::operator()(calculate_join_cost_tag, const PLAN_TABLE &PT, const QueryGraph &G, \
                                                    const CardinalityEstimator &CE, Subproblem left, Subproblem right, \
                                                    const cnf::CNF &condition) const; \
    template double TrainedCostFunction::operator()(calculate_grouping_cost_tag, const PLAN_TABLE &PT, const QueryGraph &G, \
                                                    const CardinalityEstimator &CE, Subproblem sub, \
                                                    const std::vector<const Expr*>&) const;
INSTANTIATE(PlanTableSmallOrDense)
INSTANTIATE(PlanTableLargeAndSparse)
INSTANTIATE(TopKPlanTable<M_COMMA(PlanTableSmallOrDense) 2>)
INSTANTIATE(TopKPlanTable<M_COMMA(PlanTableLargeAndSparse) 2>)
INSTANTIATE(TopKPlanTable<M_COMMA(PlanTableSmallOrDense) 3>)
INSTANTIATE(TopKPlanTable<M_COMMA(PlanTableLargeAndSparse) 3>)
INSTANTIATE(TopKPlanTable<M_COMMA(PlanTableSmallOrDense) 5>)
INSTANTIATE(TopKPlanTable<M_COMMA(PlanTableLargeAndSparse) 5>)
INSTANTIATE(TopKPlanTable<M_COMMA(PlanTableSmallOrDense) 10>)
INSTANTIATE(TopKPlanTable<M_COMMA(PlanTableLargeAndSparse) 10>)
INSTANTIATE(TopKPlanTable<M_COMMA(PlanTableSmallOrDense) 34>)
INSTANTIATE(TopKPlanTable<M_COMMA(PlanTableLargeAndSparse) 34>)
INSTANTIATE(TopKPlanTable<M_COMMA(PlanTableSmallOrDense) 35>)
INSTANTIATE(TopKPlanTable<M_COMMA(PlanTableLargeAndSparse) 35>)
INSTANTIATE(HolisticPlanTable<PlanTableSmallOrDense>)
INSTANTIATE(HolisticPlanTable<PlanTableLargeAndSparse>)
#undef INSTANTIATE
